...
# Install dependencies to run the API in a separate venv to isolate different components
...
# Install dependencies to run the UI in a separate venv to isolate different components
...
# Configure docker-in-docker: ensure the user is added to the docker group if needed
...
# Grant the user sudo access without a password
